...
if (typeof zim_fix_wasm_target === 'undefined') {
    ...
    zim_fix_wasm_target = function(target) {
        ...
        if (hasImageNamespacePrefix(target)) {
            ...
            target = ZIM_IMG_NS + "vendors/ogvjs/" + target;
        }
...
def main():
    ...
    ogvjs_path = root.joinpath("templates", "vendors", "ogvjs")
    for fname in [
    ...
    plugin_path = root.joinpath("templates", "vendors", "videojs-ogvjs.js")
    ...
    videojs_path = root.joinpath("templates", "vendors", "videojs", "video.min.js")
